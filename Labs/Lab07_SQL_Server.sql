...
as
declare @x XML
set @x = (Select driver.firstName [Имя_водителя], 
trnumber.taransportNumber [Номер_автомобиля], car.typeOfService [Тип_перевозки], GETDATE() [Дата]  
...
as
DECLARE  @s XML  
SET @s = (Select d.firstName [Имя], t.taransportNumber [Номер_автомобиля], 
car.typeOfService [Тип_перевозки], GETDATE() [Дата] 
